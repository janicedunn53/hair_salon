...
describe(Stylist) do
  ...
  describe('#delete') do
    it("lets you delete a stylist from the database") do
      stylist = Stylist.new({:name => "Julie", :id => nil})
      stylist.save()
      stylist2 = Stylist.new({:name => "Theresa", :id => nil})
      stylist2.save()
      stylist.delete()
    ...
    it("deletes a stylist's clients from the database") do
      stylist = Stylist.new({:name => "Julie", :id => nil})
      stylist.save()
      client = Client.new({:description => "Jeff_haircut", :stylist_id => stylist.id()})
      client.save()
      client2 = Client.new({:description => "Anna_highlights", :stylist_id => stylist.id()})
      client2.save()
      stylist.delete()
